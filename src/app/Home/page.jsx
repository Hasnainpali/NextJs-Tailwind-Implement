  ...
  return (
    <div>
       ...
       <div className="md:flex">
        ...
        <div className="">
            <img className="h-96 w-screen object-fit md:h-screen md:w-screen" src="https://images.pexels.com/photos/13261147/pexels-photo-13261147.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt=""  />
        </div> 
      </div> 
    </div>
  )
